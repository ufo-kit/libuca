                                ...
                                GError **error)
{
    ...
    // If the camera name is net, we change it to netXX where XX is the net_camera_counter.
    // Then we increment the net_camera_counter.
    // If there is no netXX-cameras the normal "net" is used if installed.
